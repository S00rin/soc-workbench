...
MODULE_CATALOG = [
    ...
    {"key": "price_analyzer", "label": "Price Analyzer", "description": "Contract analysis, effort estimation, WBS, Gantt, RACI and cost calculation"},
    {"key": "sensors", "label": "Sensor Library", "description": "Equipment and sensor catalog, log sources, runbooks and playbooks"},
...
FEATURE_CATALOG = [
    ...
    {"key": "module.price_analyzer", "label": "Price Analyzer", "module": "price_analyzer"},
    {"key": "module.sensors", "label": "Sensor Library", "module": "sensors"},
